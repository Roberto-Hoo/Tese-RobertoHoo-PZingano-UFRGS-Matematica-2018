...
INTEGER, PARAMETER ::  M1 = -200, M2 = 200   ! <--- x-grid is: x(M1),...,x(M2)
INTEGER, PARAMETER ::  N1 = -200, N2 = 200   ! <--- y-grid is: y(N1),...,y(N2)
...
REAL*8   mass1, mass2, mass3    ! mass of initial cones relative to height b
...
REAL*8   media_du_sobre_dt_0, sup_du_sobre_dt_0
...
x1 = +2.0D0;   ! <--- x-coordinate of 1st singularity
...
media_du_sobre_dt_0 = (sum( u(M1:M2,N1:N2) - u0 )/dt)/((M2-M1+1)*(N2-N1+1));

sup_du_sobre_dt_0 = maxval( abs( u(M1:M2,N1:N2) - u0 ) )/dt;
...
write(10,520)  media_du_sobre_dt_0
write(10,520)  sup_du_sobre_dt_0
...
write(10,520)
write(10,520) media_du_sobre_dt_0, sup_du_sobre_dt_0
