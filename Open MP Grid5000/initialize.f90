 ...
 !  COMPUTATIONAL REGION will be: [-26, 26] x [-26, 26],  with h = 0.1:
    ...
    INTEGER, PARAMETER ::  M1 = -260, M2 = 260   ! <--- x-grid is: x(M1),...,x(M2)
    INTEGER, PARAMETER ::  N1 = -260, N2 = 260   ! <--- y-grid is: y(N1),...,y(N2)
    INTEGER, PARAMETER ::  Nthreads = 40         ! <--- no. of threads in OMP parallel regions
    
    REAL*8,  PARAMETER ::  refv1 = 10.0D0  ! <--- main position of far field ZONE 1
    REAL*8,  PARAMETER ::  refv2 = 12.5D0  ! <--- main position of far field ZONE 2
    REAL*8,  PARAMETER ::  refv3 = 15.0D0  ! <--- main position of far field ZONE 3
